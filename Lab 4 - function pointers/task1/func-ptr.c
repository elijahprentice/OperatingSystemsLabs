...
int my_comparer(const void *this, const void *that)
{
  ...
  //qsort implementation: https://en.cppreference.com/w/cpp/algorithm/qsort
  Process *firstProc = (Process*)this;
  Process *secndProc = (Process*)that;
  
  return(firstProc->priority > secndProc->priority ? -1 :
         
         firstProc->priority < secndProc->priority ? 1 :
         
           firstProc->arrival_time > secndProc->arrival_time ? 1 : -1);
